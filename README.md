...
https://github.com/fastrgv/WorldCupSokerban/releases/download/v3.1.7/sban15apr17.tar.gz


WorldCupSokerban v3.1.7
Changes (newest @ top):
...
This is a soccer-themed, 3D sokoban puzzle game. It uses sokoban puzzle data in a format that is commonly found on the internet.
...
Andres Cantor sound downloaded from YouTube and trimmed with FFMPEG. Kick sound is from freesound.org so is covered by the Creative Commons Noncommercial License; see http://creativecommons.org/licenses/by-nc/3.0/legalcode/
ImageFiles
